...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <%
   ...
   String kehuId= session.getAttribute("kehuId").toString();
    ...
    sql="select sqrName,bxName,bxje,shijian,jindu,jieguo,fujian,id from t_baodan where jieguo='请等待审批结果'  and  sqrID='"+ kehuId +"'   " ;
   ...
   %>
	...
	<body leftmargin="2" topmargin="2" background='<%=path %>/images/allbg.gif'>
		<form action="baoxiaoXX1.jsp" name="formAdd" method="post">
