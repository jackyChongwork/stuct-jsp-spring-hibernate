...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <%
    ...
    sql="select sqrName,bxName,bxje,shijian,jindu,jieguo,fujian,id from t_baodan where jieguo='通过'  and  sqrID='"+ kehuId +"'   " ;
   ...
   %>
	...
	<body leftmargin="2" topmargin="2" background='<%=path %>/images/allbg.gif'>
		<form action="baoxiaoXX2.jsp" name="formAdd" method="post">
