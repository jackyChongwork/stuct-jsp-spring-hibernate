...
<% 
    ...
    String sql="insert into t_baodan(kehuID,baodanName,bxje,kaishishijian,jieshushijian,con,zt,chepai,qicheppai,qichexinghao) values('"
    	+ t2 +"','"+ t1 +"','"+ t3 +"','"+ t4 +"','"+ t5 +"','"+ t6 +"','生效中','"+ t11 +"','"+ t12 +"','"+ t13 +"') ";
